        ...
        <div class="header-wrapper">
          ...
          <div>
            ...
            <el-card class="patient-card" shadow="always" v-if="patientList.length > 0">
              ...
              <div class="card SELF_PAY_CARD">
                <div class="info"><span class="type">{{ patient.isInsure == 0 ? '自费' : '医保' }}</span><span
                    class="card-no">{{ patient.certificatesNo }}</span><span class="card-view">居民身份证</span></div>
            ...
            <div class="content-wrapper">
              <el-form ref="schedule">
                <el-form-item label="就诊日期：">
                  <div class="content"><span>{{ schedule.workDate }} {{ schedule.param.dayOfWeek }} {{ schedule.workTime
                      == 0 ? '上午' : '下午'
                  }}</span></div>
                </el-form-item>
            ...
            <div>
              ...
              <div class="content-wrapper">
                <el-form ref="patient" :model="patient">
